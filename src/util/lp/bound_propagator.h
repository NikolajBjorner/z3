...
public :
    ...
    void propagate();
    void propogate_bound_on_var_on_coeff(int j, const mpq &a);
    void propogate_for_minus();
    void propogate_for_plus();
    void propogate_bound_on_pivot_row_one_var_case_boxed_fixed(int j, const mpq & a);
    ...
    void fill_bound_evidence_plus_on_coeff_a_pos(unsigned j, const mpq & a, bound_evidence & be);
    void fill_bound_evidence_plus_on_coeff_a_neg(unsigned j, const mpq & a, bound_evidence & be);
};
}
